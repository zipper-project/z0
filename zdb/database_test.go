...
func newTestLDB() (*zdb.LDBDatabase, func()) {
	...
	db, err := zdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func TestMemoryDB_PutGet(t *testing.T) {
	testPutGet(zdb.NewMemDatabase(), t)
}

func testPutGet(db zdb.Database, t *testing.T) {
	t.Parallel()
...
func TestMemoryDB_ParallelPutGet(t *testing.T) {
	testParallelPutGet(zdb.NewMemDatabase(), t)
}

func testParallelPutGet(db zdb.Database, t *testing.T) {
	const n = 8
