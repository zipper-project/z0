...
type Database struct {
	diskdb zdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb zdb.Database) *Database {
	return &Database{
		diskdb:    diskdb,
...
func (db *Database) commit(hash common.Hash, batch zdb.Batch) error {
