...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *zdb.MemDatabase {
	var provers []func(key []byte) *zdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *zdb.MemDatabase {
		proof := zdb.NewMemDatabase()
